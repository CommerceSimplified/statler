...
goog.exportSymbol('proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1', null, global);
 ...
 * @const
 */
proto.envoy.api.v2.Cluster.oneofGroups_ = [[23,34,37]];
...
proto.envoy.api.v2.Cluster.prototype.getLbConfigCase = function() {
  return /** @type {proto.envoy.api.v2.Cluster.LbConfigCase} */(jspb.Message.computeOneofCase(this, proto.envoy.api.v2.Cluster.oneofGroups_[0]));
};
...
proto.envoy.api.v2.Cluster.RingHashLbConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    deprecatedV1: (f = msg.getDeprecatedV1()) && proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.toObject(includeInstance, f),
...
proto.envoy.api.v2.Cluster.RingHashLbConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1;
      reader.readMessage(value,proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.deserializeBinaryFromReader);
...
proto.envoy.api.v2.Cluster.RingHashLbConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.serializeBinaryToWriter
    );
  }
 ...
 * @constructor
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1 = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.displayName = 'proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1';
}
 ...
 * @return {!Object}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.prototype.toObject = function(opt_includeInstance) {
  return proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.toObject = function(includeInstance, msg) {
  var f, obj = {
    useStdHash: (f = msg.getUseStdHash()) && google_protobuf_wrappers_pb.BoolValue.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1;
  return proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUseStdHash();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
...
/**
 * optional google.protobuf.BoolValue use_std_hash = 1;
 * @return {?proto.google.protobuf.BoolValue}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.prototype.getUseStdHash = function() {
...
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.prototype.setUseStdHash = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.prototype.clearUseStdHash = function() {
  this.setUseStdHash(undefined);
};
 ...
 * @return {boolean}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1.prototype.hasUseStdHash = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
/**
 * optional DeprecatedV1 deprecated_v1 = 2;
 * @return {?proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.prototype.getDeprecatedV1 = function() {
  return /** @type{?proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1, 2));
};


/** @param {?proto.envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1|undefined} value */
proto.envoy.api.v2.Cluster.RingHashLbConfig.prototype.setDeprecatedV1 = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.envoy.api.v2.Cluster.RingHashLbConfig.prototype.clearDeprecatedV1 = function() {
 ...
 * @return {boolean}
 */
proto.envoy.api.v2.Cluster.RingHashLbConfig.prototype.hasDeprecatedV1 = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.envoy.api.v2.Cluster.prototype.setRingHashLbConfig = function(value) {
  jspb.Message.setOneofWrapperField(this, 23, proto.envoy.api.v2.Cluster.oneofGroups_[0], value);
};
...
proto.envoy.api.v2.Cluster.prototype.setOriginalDstLbConfig = function(value) {
  jspb.Message.setOneofWrapperField(this, 34, proto.envoy.api.v2.Cluster.oneofGroups_[0], value);
};
...
proto.envoy.api.v2.Cluster.prototype.setLeastRequestLbConfig = function(value) {
  jspb.Message.setOneofWrapperField(this, 37, proto.envoy.api.v2.Cluster.oneofGroups_[0], value);
};
